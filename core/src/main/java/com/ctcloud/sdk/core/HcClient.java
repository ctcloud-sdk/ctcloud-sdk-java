...
package com.ctcloud.sdk.core;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.ctcloud.sdk.core.auth.ICredential;
import com.ctcloud.sdk.core.exception.DefaultExceptionHandler;
import com.ctcloud.sdk.core.exception.ExceptionHandler;
import com.ctcloud.sdk.core.exception.HostUnreachableException;
import com.ctcloud.sdk.core.exception.SdkException;
import com.ctcloud.sdk.core.exception.ServerResponseException;
import com.ctcloud.sdk.core.exception.ServiceResponseException;
import com.ctcloud.sdk.core.exchange.ApiReference;
import com.ctcloud.sdk.core.exchange.SdkExchange;
import com.ctcloud.sdk.core.exchange.SdkExchangeCache;
import com.ctcloud.sdk.core.http.Field;
...
import com.ctcloud.sdk.core.http.SdkFormDataBody;
import com.ctcloud.sdk.core.impl.DefaultHttpClient;
import com.ctcloud.sdk.core.progress.ProgressInputStream;
import com.ctcloud.sdk.core.progress.ProgressRequest;
import com.ctcloud.sdk.core.progress.SimpleProgressManager;
import com.ctcloud.sdk.core.utils.CastUtils;
import com.ctcloud.sdk.core.utils.ExceptionUtils;
import com.ctcloud.sdk.core.utils.HttpUtils;
import com.ctcloud.sdk.core.utils.JsonUtils;
...
import static com.ctcloud.sdk.core.Constants.SDK_EXCHANGE;
...
public class HcClient implements CustomizationConfigure {
    ...
    public static class AccessLog {
        private static final Logger logger = LoggerFactory.getLogger("CtCloud-SDK-Access");
    ...
    protected <R, S> HttpRequest buildRequest(R request, HttpRequestDef<R, S> reqDef) {
        ...
        httpRequestBuilder.addHeader(Constants.USER_AGENT, "ctcloud-usdk-java/3.0");
