...
public final class Constants {
    ...
    public static final String DEFAULT_IAM_ENDPOINT = "https://iam.ru-moscow-1.hc.sbercloud.ru";

    public static final String IAM_ENDPOINT_ENV_NAME = "CTCLOUD_SDK_IAM_ENDPOINT";

    public static final String DEFAULT_ENDPOINT_REG =
            "^[a-z][a-z0-9-]+(\\.[a-z]{2,}-[a-z]+-\\d{1,2})?\\.(my)?(sbercloud).(com|ru)";

    public static final String GLOBAL_REGION_ID = "globe";

    public static final String DEFAULT_PROFILE_DIR_NAME = ".ctcloud";
